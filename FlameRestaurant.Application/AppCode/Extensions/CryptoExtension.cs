...
namespace FlameRestaurant.Application.AppCode.Extenstions
{
    ...
    {
        const string saltKey = "final@@FlameRestaurant!";
        public static string ToMd5(this string value)
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}FlameRestaurant.Application.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}2FlameRestaurant.Application.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}1FlameRestaurant.Application.AppCode.Extensions");
